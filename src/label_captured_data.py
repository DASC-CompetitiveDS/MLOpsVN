...
def label_captured_data(prob_config: ProblemConfig, ratio_cluster: int):
    ...
    for i in range(n_cluster):
        ...
        cluster_labels = train_y[mask].values  # labels of data points in cluster i
...
if __name__ == "__main__":
    ...
    label_captured_data(prob_config, args.ratio_cluster)
