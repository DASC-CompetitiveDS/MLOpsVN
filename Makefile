...
# predictor
predictor_up:
	bash deployment/deploy.sh run_predictor data/model_config/phase-2/prob-1/phase-2_prob-1_lgbm__.yaml data/model_config/phase-2/prob-2/phase-2_prob-2_lgbm__add_captured_data.yaml 5041
...
predictor_curl:
	curl -X POST http://localhost:5040/phase-2/prob-1/predict -H "Content-Type: application/json" -d @data/curl/phase-2/prob-1/payload-1.json
	curl -X POST http://localhost:5040/phase-2/prob-1/predict -H "Content-Type: application/json" -d @data/curl/phase-2/prob-1/payload-2.json
