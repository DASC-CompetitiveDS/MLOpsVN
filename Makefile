...
# predictor
predictor_up:
	bash deployment/deploy.sh run_predictor data/model_config/phase-1/prob-1/phase-1_prob-1_lgbm_.yaml data/model_config/phase-1/prob-2/phase-1_prob-2_lgbm_.yaml 5041
