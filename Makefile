...
# predictor
predictor_up:
	bash deployment/deploy.sh run_predictor data/model_config/phase-2/prob-1/phase-2_prob-1_cv.yaml data/model_config/phase-2/prob-2/phase-2_prob-2_lgbm_add_captured_data_cv.yaml False 5041
