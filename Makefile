...
# predictor
predictor_up:
	bash deployment/deploy.sh run_predictor data/model_config/phase-2/prob-1/phase-2_prob-1_lgbm__.yaml data/model_config/phase-2/prob-2/phase-2_prob-2_lgbm___specific_handle.yaml True 5041
