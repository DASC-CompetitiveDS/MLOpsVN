...
from data_processing.specific_data_processing import ProcessData
...
class RawDataProcessor:
    ...
    @staticmethod
    def process_raw_data(remove_dup: str, order_reg: bool, specific_handle: bool, drift: bool, external_data: bool, kfold: bool, **kwargs):
...
if __name__ == "__main__":
    ...
    if args.remove_dup not in ['abs', 'rel', 'None']:
        ...
        RawDataProcessor.process_raw_data(args.remove_dup, args.order_reg, args.specific_handle, args.drift, args.external_data, args.kfold)
